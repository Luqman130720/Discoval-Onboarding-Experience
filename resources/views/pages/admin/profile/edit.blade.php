                        ...
                        <form action="{{ route('operator.profile.update', $user->id) }}" method="POST"
                            ...
                            <div class="mt-4 mt-lg-3 mb-4 text-center">
                                <a href="javascript:;" class="d-block">
                                    <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('../assets/img/team-2.jpg') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" id="photo" name="profile_picture"
                                        accept="image/*"
                                        onchange="previewImage(event, 'profilePicturePreview', '{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('../assets/img/team-2.jpg') }}')">
