                    ...
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <div class="mt-n4 mt-lg-n6 mb-4">
                                <a href="javascript:;">
                                    <img src="{{ $teacher->profile_picture ? asset('storage/' . $teacher->profile_picture) : asset('../assets/img/team-2.jpg') }}"
                            ...
                            <div class="mt-4 mt-lg-3 mb-4 text-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" id="photo" name="profile_picture"
                                        accept="image/*"
                                        onchange="previewImage(event, 'profilePicturePreview', '{{ $teacher->profile_picture ? asset('storage/' . $teacher->profile_picture) : asset('../assets/img/team-2.jpg') }}')">
